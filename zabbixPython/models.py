...
class Alerts(models.Model):
    ...
    eventid = models.ForeignKey('Events', models.DO_NOTHING, db_column='eventid',related_name='eventid_r')
    ...
    p_eventid = models.ForeignKey('Events', models.DO_NOTHING, db_column='p_eventid', blank=True, null=True)
...
class ApplicationTemplate(models.Model):
    ...
    applicationid = models.ForeignKey('Applications', models.DO_NOTHING, db_column='applicationid',related_name='applicationid_r')
    templateid = models.ForeignKey('Applications', models.DO_NOTHING, db_column='templateid',related_name='templateid_r')
...
class EventRecovery(models.Model):
    ...
    r_eventid = models.ForeignKey('Events', models.DO_NOTHING, db_column='r_eventid',related_name='er_eventid_r')
    c_eventid = models.ForeignKey('Events', models.DO_NOTHING, db_column='c_eventid', blank=True, null=True,related_name='c_eventid_r')
...
class GraphDiscovery(models.Model):
    graphid = models.OneToOneField('Graphs', models.DO_NOTHING, db_column='graphid', primary_key=True,related_name='graphid_r')
    parent_graphid = models.ForeignKey('Graphs', models.DO_NOTHING, db_column='parent_graphid',related_name='parent_graphid_r')
...
class Graphs(models.Model):
    ...
    ymax_itemid = models.ForeignKey('Items', models.DO_NOTHING, db_column='ymax_itemid', blank=True, null=True,related_name='ymax_itemid_r')
    flags = models.IntegerField()
...
class HostDiscovery(models.Model):
    ...
    parent_hostid = models.ForeignKey('Hosts', models.DO_NOTHING, db_column='parent_hostid', blank=True, null=True,related_name='parent_hostid_r')
...
class Hosts(models.Model):
    ...
    proxy_hostid = models.ForeignKey('self', models.DO_NOTHING, db_column='proxy_hostid', blank=True, null=True,related_name='proxy_hostid_r')
...
class HostsTemplates(models.Model):
    ...
    hostid = models.ForeignKey(Hosts, models.DO_NOTHING, db_column='hostid')
    templateid = models.ForeignKey(Hosts, models.DO_NOTHING, db_column='templateid',related_name='templateid_r')
...
class InterfaceDiscovery(models.Model):
    interfaceid = models.OneToOneField(Interface, models.DO_NOTHING, db_column='interfaceid', primary_key=True,related_name='interfaceid_r')
...
class ItemDiscovery(models.Model):
    ...
    itemid = models.ForeignKey('Items', models.DO_NOTHING, db_column='itemid')
    parent_itemid = models.ForeignKey('Items', models.DO_NOTHING, db_column='parent_itemid',related_name='parent_itemid_r')
...
class Items(models.Model):
    ...
    templateid = models.ForeignKey('self', models.DO_NOTHING, db_column='templateid', blank=True, null=True,related_name='templateid_r')
    ...
    master_itemid = models.ForeignKey('self', models.DO_NOTHING, db_column='master_itemid', blank=True, null=True)
...
class Problem(models.Model):
    ...
    clock = models.IntegerField()
    ns = models.IntegerField()
    r_eventid = models.ForeignKey(Events, models.DO_NOTHING, db_column='r_eventid', blank=True, null=True,related_name='r_eventid_r')
...
class ServicesLinks(models.Model):
    ...
    serviceupid = models.ForeignKey(Services, models.DO_NOTHING, db_column='serviceupid',related_name='serviceupid_r')
...
class SysmapsElements(models.Model):
    ...
    elementtype = models.IntegerField()
    iconid_off = models.ForeignKey(Images, models.DO_NOTHING, db_column='iconid_off', blank=True, null=True,related_name='iconid_off_r')
    iconid_on = models.ForeignKey(Images, models.DO_NOTHING, db_column='iconid_on', blank=True, null=True,related_name='iconid_on_r')
    ...
    iconid_maintenance = models.ForeignKey(Images, models.DO_NOTHING, db_column='iconid_maintenance', blank=True, null=True,related_name='iconid_maintenance_r')
...
class SysmapsLinks(models.Model):
    linkid = models.BigIntegerField(primary_key=True)
    sysmapid = models.ForeignKey(Sysmaps, models.DO_NOTHING, db_column='sysmapid')
    selementid1 = models.ForeignKey(SysmapsElements, models.DO_NOTHING, db_column='selementid1',related_name='selementid1_r')
...
class TriggerDepends(models.Model):
    ...
    triggerid_up = models.ForeignKey('Triggers', models.DO_NOTHING, db_column='triggerid_up',related_name='triggerid_up_r')
...
class TriggerDiscovery(models.Model):
    triggerid = models.OneToOneField('Triggers', models.DO_NOTHING, db_column='triggerid', primary_key=True,related_name='triggerid_r')
    parent_triggerid = models.ForeignKey('Triggers', models.DO_NOTHING, db_column='parent_triggerid')
